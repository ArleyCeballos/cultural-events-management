...
const EventsBySpaces = lazy(() => import('@/components/Reports/EventsBySpaces'));
const EventsByModalities = lazy(() => import('@/components/Reports/EventsByModalities'));

const ReportPage = () => {
    const [selectedChart, setSelectedChart] = useState('Todos');

    const handleChangeChart = (chartType: string) => {
